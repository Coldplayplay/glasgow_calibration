...
public:
    ...
    vector<Mat> rvecs_robot, tvecs_robot; // For robot positions while calibrating a camera

    //For camera position from planar surface (runExtrinsic)
    Mat rvecEx;
    Mat tvecEx;
